...
export enum TransactionType {
  ...
  SAVING_INTEREST_ADD_REVERSAL = 'SAVING_INTEREST_ADD_REVERSAL',
  SAVING_INTEREST_DISTRIBUTION_REVERSAL = 'SAVING_INTEREST_DISTRIBUTION_REVERSAL',
  LOAN_REPAYMENT = 'LOAN_REPAYMENT',
  LOAN_REPAYMENT_REVERSAL = 'LOAN_REPAYMENT_REVERSAL',
  LOAN_INTEREST_PAYMENT = 'LOAN_INTEREST_PAYMENT',
  LOAN_INTEREST_REVERSAL = 'LOAN_INTEREST_REVERSAL',
