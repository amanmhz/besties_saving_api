...
export class ReportsService {
  ...
  async getDashboardStats() {
    const [totalSavings, activeLoans, totalMembers, cashFlow, loanInterest, bankInterest, bankInterestPool, distributedInterest] = await Promise.all([
      this.savingRepo
    ...
    return {
      ...
      totalInterest: {
        ...
        distributed: parseFloat(distributedInterest?.sum || '0'),
      },
